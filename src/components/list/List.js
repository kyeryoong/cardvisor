    ...
    return (
        <div>
            ...
            <br /><br /><br />     
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 1]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 2]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 3]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 4]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 5]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 6]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 7]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 8]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 9]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 10]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 11]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 12]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 13]?.id != 'undefined' &&
                        <ListElement
                    ...
                    {typeof cards?.cardAll[indexOfFirst + 14]?.id != 'undefined' &&
                        < ListElement
            ...
            <div className={styles.pageButtonGroup}>
                <button className={styles.leftPageButton} onClick={() => {
                    if (startOfPage - 10 >= 1) {
                        setStartOfPage(startOfPage - 10);
                        setEndOfPage(endOfPage - 10);
                    }
                }}>
                    <img alt="arrow_up" className={styles.arrow} src={process.env.PUBLIC_URL + "/images/icons/arrow_left_blue.png"} />
                </button>

                <PageButton pageNumber={startOfPage} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 1} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 2} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 3} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 4} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 5} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 6} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 7} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 8} maxPageNumber={27} currentPageNumber={currentPage} />
                <PageButton pageNumber={startOfPage + 9} maxPageNumber={27} currentPageNumber={currentPage} />

                <button className={styles.rightPageButton} onClick={() => {
                    if (endOfPage <= totalPages) {
                        setStartOfPage(startOfPage + 10);
                        setEndOfPage(endOfPage + 10);
                    }
                }}>
                    <img alt="arrow_up" className={styles.arrow} src={process.env.PUBLIC_URL + "/images/icons/arrow_right_blue.png"} />
                </button>
            </div>
            <br /><br /><br />
